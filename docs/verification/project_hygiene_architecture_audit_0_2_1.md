...
- Audit de confidentialite du lot publiable : `PASS`, 1552 fichiers, 0 finding.
- Gate `release-vv` courant : `FAIL`.
- Git : HEAD `1804a03`, tag `v0.2.0-alpha`, 417 fichiers modifies et 319 fichiers non suivis.
...
L'identite complete de l'auteur/Owner reste volontairement presente dans 143 fichiers de metadonnees, attribution et revues signees. Ce n'est pas une donnee de poste, mais c'est bien une information personnelle publiee; elle doit rester un choix explicite du proprietaire.
...
Points a corriger :
1. `scripts/` contient 206 fichiers Python a plat, dont 130 runners `run_*`. Les classer sous `scripts/vnv/code_aster`, `scripts/vnv/calculix`, `scripts/vnv/internal`, `scripts/docs` et `scripts/release`, avec wrappers temporaires si un chemin public est documente.
...
| `scripts/build_owner_review_audit_pack.py` | 699 |

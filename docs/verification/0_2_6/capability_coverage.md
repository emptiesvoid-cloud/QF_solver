...
- Capability count: 31; public mappings: 31
- V&V distribution: L0=0, L1=3, L2=15, L3=13
...
| `MAT-COUPLED-NL` | MATERIAL | bounded solid/contact workflows | coupled nonlinear | RESEARCH | L1 | `026-G10` | RESEARCH_DEFERRED |
...
- TET10, HEX8, HEX20, BEAM2, and discrete have no G05 READY mapping; refinement policies remain UNDEFINED_POLICY.
...
| `MAT-COUPLED-NL` | 0.2.5 recorded | RESEARCH | present; no silent maturity downgrade |

...
Implementation commit: `653b1e8879ed33b9e03939d72167a1d6ab831399`.
...
`C:\Users\fari\AppData\Local\Temp\wp08d_m1_active_set_fix_regression\M1\`
...
seven `STEP_ACCEPTED` events. Each contact-state event carried a
`convergence_cause`; no fallback or step rejection occurred in this open-
contact control.
...
- targeted WP08/contact regression tests: `53 passed`;

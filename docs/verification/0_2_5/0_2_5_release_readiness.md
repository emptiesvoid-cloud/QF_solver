...
| 025-G06 | OPEN | `results/vnv_0_2_5/g06_latest/summary.json`, `report.md`, `evidence_manifest.json` | Internal coupled paths and 1/2/4 J2+geometry mesh replay pass as research evidence; geometry+contact mesh sensitivity, Code_Aster MUST coupled full histories, and complete coupled energy/tangent evidence remain missing |

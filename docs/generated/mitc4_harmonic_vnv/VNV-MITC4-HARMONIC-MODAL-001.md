...
| ---: | ---: | ---: | ---: |
| 0.010 | 1.564734e-02 | -90.000 | 2.499e-07 |
| 0.020 | 7.823669e-03 | -90.000 | 1.254e-07 |
| 0.050 | 3.129467e-03 | -90.000 | 5.077e-08 |

Statut : **PASS**.

![Reponse harmonique](VNV-MITC4-HARMONIC-MODAL-001-response.png)

![Sensibilite amortissement](VNV-MITC4-HARMONIC-MODAL-001-damping.png)

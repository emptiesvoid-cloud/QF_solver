...
- [Consolidated machine-readable registry](../../qualification/0_2_8/consolidated_registry.json)
...
| --- | --- | --- |
| Connected conforming mixed static | `QUALIFIED_BOUNDED` | [WP07 Owner record](../../qualification/0_2_8/wp07_owner_gate_final.json) |
| Connected conforming mixed modal | `QUALIFIED_BOUNDED` | [WP08B Owner record](../../qualification/0_2_8/wp08b_owner_gate_final.json) |
| Translational MPC mixed static | `QUALIFIED_BOUNDED` | [WP13-03D delivery](../../qualification/0_2_8/wp13_03d_mixed_mpc_owner_delivery.json) |
| Multi-material mixed static | `QUALIFIED_BOUNDED` | [WP13-04D delivery](../../qualification/0_2_8/wp13_04d_multimaterial_owner_delivery.json) |
| Mixed Newmark linear dynamics | `EXPERIMENTAL_BOUNDED` | [WP13-02D delivery](../../qualification/0_2_8/wp13_02d_mixed_dynamics_delivery.json) |
| Mixed harmonic linear response | `EXPERIMENTAL_BOUNDED` | [WP13-02D delivery](../../qualification/0_2_8/wp13_02d_mixed_dynamics_delivery.json) |
...
| --- | --- | --- |
| Bounded Abaqus/CalculiX `.inp` importer | `EXPERIMENTAL_BOUNDED` | [WP13-05 capability record](../../qualification/0_2_8/wp13_05_inp_import_capability_record.json) |
| Family-aware mixed HDF5 result storage | `EXPERIMENTAL_BOUNDED` | [WP13-06D capability record](../../qualification/0_2_8/wp13_06d_mixed_hdf5_capability_record.json) |
| Frictionless penalty node-to-triangle contact | `EXPERIMENTAL_BOUNDED` | [WP13-07D capability record](../../qualification/0_2_8/wp13_07d_contact_capability_record.json) |
| HEX8 selective reduced integration | `EXPERIMENTAL_BOUNDED` | [WP10 Owner record](../../qualification/0_2_8/wp10_hex8_sri_owner_gate_final.json) |
...
| --- | --- | --- |
| PYRAMID5 | `INTERNAL / RESEARCH_ONLY` | [WP13-10 maturation evidence](../../qualification/0_2_8/wp13_10_pyramid5_maturation/wp13_10_pyramid5_maturation_evidence.json) |
| Geometric nonlinear discovery | `RESEARCH_ONLY` | [WP13-11 evidence](../../qualification/0_2_8/wp13_11_geometric_nonlinear_discovery/manifest.json) |
| High-order mixed-interface feasibility | `RESEARCH_ONLY` | [WP13-09 evidence](../../qualification/0_2_8/wp13_09_high_order_interface_feasibility/wp13_09_feasibility_evidence.json) |

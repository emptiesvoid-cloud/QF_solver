...
CURRENT_METADATA_SHA = "15fe5f846b803cc02008de36d3c53065d9522807"
...
def test_lu2_plan_has_exact_scope_and_weight_accounting() -> None:
    ...
    assert accounting["level_up_2"]["acquired_percent"] == 50
    assert accounting["current_global_progress_percent"] == 100
...
def test_lu2_state_index_and_existing_lu1_are_consistent() -> None:
    ...
    assert state["global_accounting"] == {
        ...
        "current_global_progress": "100/100",
...
def test_current_governance_consumers_point_to_lu2_and_keep_baseline_roles() -> None:
    ...
    assert lu2_gates["status"] == "CLOSED"
    ...
    assert lu2_requirements[8]["status"] == "PASS_WITH_LIMITATIONS"

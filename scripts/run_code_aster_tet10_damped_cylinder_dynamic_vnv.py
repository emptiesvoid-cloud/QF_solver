"""Run the damped circular TET10/Code_Aster dynamic correlation."""
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        / "tet10_dynamic_damped_cylinder_code_aster",
    )
    parser.add_argument("--mesh-size", type=float, default=0.32)
    args = parser.parse_args()
    summary = CodeAsterTet10DampedCylinderDynamicsCampaign(

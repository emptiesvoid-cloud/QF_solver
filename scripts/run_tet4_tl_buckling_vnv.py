"""Run the TET4 total-Lagrangian Euler buckling benchmark."""
...
def main() -> int:
    output = Path("results/VNV-TET4-TL-BUCKLING-EULER-006")
    summary = TotalLagrangianBucklingCampaign(output).run()

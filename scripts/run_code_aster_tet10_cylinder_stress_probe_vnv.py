"""Run the TET10 cylindrical interior stress probe correlation."""
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        / "tet10_stress_probe_cylinder_code_aster",
    )
    args = parser.parse_args()
    summary = CodeAsterTet10CylinderStressProbeCampaign(args.output).run()

...
OUTPUT_ROOT = Path("qualification/0_2_9/wp12_external_vv_r3_5_smoke_attempt4_raw")
REPORT_PATH = Path("qualification/0_2_9/wp12_external_vv_r3_5_mesh_smoke_attempt4.json")
MANIFEST_PATH = Path("qualification/0_2_9/wp12_external_vv_r3_5_mesh_smoke_attempt4_manifest.json")
...
def main() -> int:
    ...
    summary = {
        "campaign": "WP12 R3.5 four-family H3 serializer/input smoke attempt 4",

        ...
        for iteration in range(1, max_iterations + 1):
            ...
            if relative <= tolerance:
                ...
                emit_telemetry(
                    ...
                    telemetry_event(
                        ...
                        linear_backward_error_eta_inf=None,
                        fallback_used=False,
                        RSS_bytes=rss_bytes,
            ...
            try:
                ...
                emit_telemetry(
                    ...
                    telemetry_event(
                        ...
                        linear_backward_error_eta_inf=exc.diagnostics.get("backward_error_eta_inf"),
            ...
            emit_telemetry(
                ...
                telemetry_event(
                    ...
                    linear_backward_error_eta_inf=diagnostics_values.get("backward_error_eta_inf"),

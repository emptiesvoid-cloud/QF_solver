"""Deprecated MITC4 command facade backed by the canonical package."""
...
from solveur.verification.mitc4_benchmarks import CantileverPlateBenchmark, ScordelisLoBenchmark, ShearLockingStudy
...
def main(argv: Sequence[str] | None = None) -> int:
    print(
        "DEPRECATION: mitc4-solver is a compatibility command; "
        "use qf-solver for new workflows.",
        file=sys.stderr,
    )
    parser = build_parser()

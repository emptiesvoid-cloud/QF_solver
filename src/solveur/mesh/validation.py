...
from solveur.mesh.mixed_validation import mixed_linear_static_scope_errors, mixed_modal_scope_errors
...
class MeshValidator:
    ...
    def _check_mechanical_rank(
        ...
        from solveur.mesh.validation_rank import check_mechanical_rank

        check_mechanical_rank(model, dofs, details, warnings)
